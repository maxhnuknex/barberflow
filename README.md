...
Основной сценарий записи через Telegram:

<p align="center">
  <img src="docs/screenshots/1.jpg" alt="BarberFlow — клиентский интерфейс 1" width="300">
  <img src="docs/screenshots/2.jpg" alt="BarberFlow — клиентский интерфейс 2" width="300">
  <img src="docs/screenshots/3.jpg" alt="BarberFlow — клиентский интерфейс 3" width="300">
</p>

### Администратор

Управление записями через административный интерфейс:

<p align="center">
  <img src="docs/screenshots/4.jpg" alt="BarberFlow — административный интерфейс" width="300">
</p>
